...
class DayBookController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $reportData = $this->getDayBookEntries($startDate, $endDate);
    ...
    /**
     * Helper to fetch and format Day Book entries for the given date range.
     */
    private function getDayBookEntries(Carbon $startDate, Carbon $endDate): array
    {
        ...
        // Fetch Owner Receivables Inflows
