...
@section('content')
    <x-common.page-breadcrumb pageTitle="Edit Party Head — {{ $party->name }}" />

    <x-common.component-card title="Edit Party Head — {{ $party->name }}" desc="Update party profile details in the system">
