...
<div class="mx-auto max-w-4xl px-4 py-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <form method="POST" action="{{ route('tenants.moveOut.store', $tenant) }}" class="px-6 py-6 space-y-6">
            ...
            $checkboxClass = 'h-5 w-5 rounded-lg border-2 border-gray-300 text-brand-600 focus:ring-brand-500 dark:border-gray-600';
            $checkLabel = 'flex items-center gap-3 text-base font-bold text-gray-800 dark:text-gray-200 cursor-pointer';
            $sectionClass = 'rounded-2xl border-2 border-gray-200 bg-gray-50/70 p-6 dark:border-gray-800 dark:bg-white/[0.02]';
            $sectionTitle = 'mb-5 text-base sm:text-lg font-black uppercase tracking-wider text-gray-800 dark:text-gray-200';
            @endphp
            ...
            <div class="flex items-center justify-between pt-4 border-t-2 border-gray-100 dark:border-gray-800">
                ...
                <button type="submit"
                    class="inline-flex items-center gap-3 rounded-2xl bg-orange-600 px-7 py-3.5 text-base font-extrabold text-white shadow-md hover:bg-orange-700 transition-colors cursor-pointer">
