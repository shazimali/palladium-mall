        ...
        <div class="flex items-center justify-between">
            ...
            @foreach($steps as $n => $label)
                ...
                <div class="flex flex-col items-center {{ $n < count($steps) ? 'flex-1' : '' }}">
                    ...
                    <div class="flex items-center w-full">
                        ...
                        <div class="relative flex-shrink-0">
                            @if($isActive)
                                ...
                                @else
                                    <div class="flex h-9 w-9 items-center justify-center rounded-full bg-green-600 text-white shadow-md ring-4 ring-green-200 dark:ring-green-900/50">
                    ...
                    {{-- Label --}}
                    <span class="mt-2 text-xs font-bold {{ $isActive ? 'text-green-600 dark:text-green-400' : ($isCompleted ? 'text-gray-700 dark:text-gray-300' : 'text-gray-400 dark:text-gray-500') }}">
                        {{ $label }}
                    </span>
                </div>
            @endforeach
