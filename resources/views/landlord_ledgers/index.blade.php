        ...
        @if($ledgerData)
            ...
            <div class="overflow-x-auto rounded-2xl border-2 border-gray-200 dark:border-gray-800 shadow-md">
                <table class="w-full text-xs sm:text-sm text-left text-gray-800 dark:text-gray-200">
                    <thead class="text-[11px] font-black uppercase tracking-wider bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-b-2 border-gray-200 dark:border-gray-700">
                        <tr>
                            ...
                            <th class="px-3.5 py-2.5 text-right">Debit (Owed)</th>
