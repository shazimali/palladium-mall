    ...
    <div class="mx-auto w-full max-w-4xl">
        <div
            ...
            <div class="flex items-center justify-between border-b border-gray-100 pb-4 dark:border-gray-800">
                <div>
                    <h2 class="text-lg font-extrabold text-gray-800 dark:text-white/90">Edit Admin Report:
                        {{ $reportType->name }}
                    </h2>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Update report identity, daily time-window
                        schedule, and settings.</p>
                </div>
