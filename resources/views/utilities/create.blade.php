...
@section('content')
    <x-common.page-breadcrumb pageTitle="Add Utility Reading" />

    <x-common.component-card title="Add Utility Reading" desc="Record meter reading and bill details for a unit">
