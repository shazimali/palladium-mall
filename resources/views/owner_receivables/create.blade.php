...
@section('content')
    <div class="mx-auto max-w-3xl px-4 py-6">
        <div class="mb-6 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>/</span>
            <span class="text-gray-800 dark:text-white/90">Record Receivable Voucher</span>
        </div>

        <x-common.component-card title="Record Owner Receivable Voucher" desc="Log a capital deposit, equity contribution, or short-term loan received from a partner">
            <form action="{{ route('owner-receivables.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6"
                x-data="{
                    amount: '{{ old('amount') }}',
                    displayAmount: '',
                    formatAmount(val) {
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="reference" value="{{ old('reference') }}" placeholder="e.g. Capital Share, Slip 4920" 
