...
@section('content')
    <div class="mx-auto max-w-2xl px-4 py-6">
        <div class="mb-6 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>/</span>
            <span class="text-gray-800 dark:text-white/90">Register SKU Item</span>
        </div>

        <x-common.component-card title="Register Inventory Item SKU" desc="Add a new item to register and track maintenance materials.">
            <form action="{{ route('items.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. LED Bulb 12W, PPR Pipe 1/2 inch" 
                    ...
                    <div>
                        ...
                        <input type="text" name="category" value="{{ old('category') }}" placeholder="e.g. Electrical, Plumbing, Cleaning" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="unit_of_measure" value="{{ old('unit_of_measure') }}" placeholder="e.g. Pcs, Coils, Liters, Boxes" 
                        ...
                        <div>
                            ...
                            <input type="number" name="min_stock_level" value="{{ old('min_stock_level', 0) }}" placeholder="e.g. 5" min="0" step="any"
                    ...
                    <div>
                        ...
                        <textarea name="description" placeholder="Specify brand, technical parameters or usage details..." rows="4"
                                  class="{{ $input }} {{ $errors->has('description') ? 'border-red-400' : '' }}">{{ old('description') }}</textarea>
