                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <a href="{{ route('dashboard.units-detail', ['status' => 'rented']) }}"
                        ...
                        <div class="relative mt-2 space-y-1.5">
                            ...
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Flats</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $overall['rented_flat'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline border-t border-white/10 pt-1.5 mt-1">
                                <span class="text-xs font-bold uppercase text-white/90">Shops</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $overall['rented_shop'] }}</span>
                            </div>
                            @if($overall['rented_office'] > 0)
                                <div class="flex justify-between items-baseline">
                                    <span class="text-xs font-bold uppercase text-white/90">Offices</span>
                                    <span class="font-extrabold text-white text-xl text-1xl">{{ $overall['rented_office'] }}</span>
                                </div>
                            @endif
                        </div>
                    </a>
                    ...
                    <a href="{{ route('dashboard.units-detail', ['status' => 'vacant']) }}"
                        ...
                        <div class="relative mt-2 space-y-1.5">
                            ...
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Flats</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $overall['vacant_flat'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline border-t border-white/10 pt-1.5 mt-1">
                                <span class="text-xs font-bold uppercase text-white/90">Shops</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $overall['vacant_shop'] }}</span>
                            </div>
                            @if($overall['vacant_office'] > 0)
                                <div class="flex justify-between items-baseline">
                                    <span class="text-xs font-bold uppercase text-white/90">Offices</span>
                                    <span class="font-extrabold text-white text-xl text-1xl">{{ $overall['vacant_office'] }}</span>
                                </div>
                            @endif
                        </div>
                    </a>
            ...
            <div class="p-6 bg-white dark:bg-white/[0.03] rounded-2xl border border-gray-200 dark:border-gray-800 shadow-theme-xs">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <a href="{{ route('dashboard.units-detail', ['type' => 'pm_mall']) }}"
                        ...
                        <div class="relative flex justify-between items-center mb-2">
                            <p class="text-sm font-extrabold uppercase tracking-wider text-white">Total PM Mall Managed</p>
                            <span class="text-base">🏢</span>
                        </div>
                        <div class="relative mt-2 space-y-1.5">
                            <div class="flex justify-between items-baseline">
                    ...
                    <a href="{{ route('dashboard.units-detail', ['type' => 'pm_mall', 'status' => 'rented']) }}"
                        ...
                        <div class="relative flex justify-between items-center mb-2">
                            <p class="text-sm font-extrabold uppercase tracking-wider text-white">Rented PM Mall Managed</p>
                            <span class="text-base">🔑</span>
                        </div>
                        <div class="relative mt-2 space-y-1.5">
                            <div class="flex justify-between items-baseline">
                            ...
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Flats</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $pmMall['rented_flat'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline border-t border-white/10 pt-1.5 mt-1">
                                <span class="text-xs font-bold uppercase text-white/90">Shops</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $pmMall['rented_shop'] }}</span>
                            </div>
                            @if($pmMall['rented_office'] > 0)
                                <div class="flex justify-between items-baseline">
                                    <span class="text-xs font-bold uppercase text-white/90">Offices</span>
                                    <span class="font-extrabold text-white text-xl text-1xl">{{ $pmMall['rented_office'] }}</span>
                                </div>
                            @endif
                        </div>
                    </a>
                    ...
                    <a href="{{ route('dashboard.units-detail', ['type' => 'pm_mall', 'status' => 'vacant']) }}"
                        ...
                        <div class="relative flex justify-between items-center mb-2">
                            <p class="text-sm font-extrabold uppercase tracking-wider text-white">Vacant PM Mall Managed</p>
                            <span class="text-base">🟢</span>
                        </div>
                        <div class="relative mt-2 space-y-1.5">
                            <div class="flex justify-between items-baseline">
                            ...
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Flats</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $pmMall['vacant_flat'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline border-t border-white/10 pt-1.5 mt-1">
                                <span class="text-xs font-bold uppercase text-white/90">Shops</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $pmMall['vacant_shop'] }}</span>
                            </div>
                            @if($pmMall['vacant_office'] > 0)
                                <div class="flex justify-between items-baseline">
                                    <span class="text-xs font-bold uppercase text-white/90">Offices</span>
                                    <span class="font-extrabold text-white text-xl text-1xl">{{ $pmMall['vacant_office'] }}</span>
                                </div>
                            @endif
                        </div>
                    </a>
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-3">
                    ...
                    <a href="{{ route('dashboard.units-detail', ['type' => 'other_owned']) }}"
                        ...
                        <div class="relative mt-2 space-y-1.5">
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Total Units</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['total'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Flats</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['flat'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline border-t border-white/10 pt-1.5 mt-1">
                                <span class="text-xs font-bold uppercase text-white/90">Shops</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['shop'] }}</span>
                            </div>
                            @if($otherOwned['office'] > 0)
                                <div class="flex justify-between items-baseline">
                                    <span class="text-xs font-bold uppercase text-white/90">Offices</span>
                                    <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['office'] }}</span>
                                </div>
                            @endif
                        </div>
                    </a>
                    ...
                    <a href="{{ route('dashboard.units-detail', ['type' => 'other_owned', 'status' => 'rented']) }}"
                        ...
                        <div class="relative mt-2 space-y-1.5">
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Total Rented</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['rented'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Flats</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['rented_flat'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline border-t border-white/10 pt-1.5 mt-1">
                                <span class="text-xs font-bold uppercase text-white/90">Shops</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['rented_shop'] }}</span>
                            </div>
                            @if($otherOwned['rented_office'] > 0)
                                <div class="flex justify-between items-baseline">
                                    <span class="text-xs font-bold uppercase text-white/90">Offices</span>
                                    <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['rented_office'] }}</span>
                                </div>
                            @endif
                        </div>
                    </a>
                    ...
                    <a href="{{ route('dashboard.units-detail', ['type' => 'other_owned', 'status' => 'vacant']) }}"
                        ...
                        <div class="relative mt-2 space-y-1.5">
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Total Vacant</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['vacant'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline">
                                <span class="text-xs font-bold uppercase text-white/90">Flats</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['vacant_flat'] }}</span>
                            </div>
                            <div class="flex justify-between items-baseline border-t border-white/10 pt-1.5 mt-1">
                                <span class="text-xs font-bold uppercase text-white/90">Shops</span>
                                <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['vacant_shop'] }}</span>
                            </div>
                            @if($otherOwned['vacant_office'] > 0)
                                <div class="flex justify-between items-baseline">
                                    <span class="text-xs font-bold uppercase text-white/90">Offices</span>
                                    <span class="font-extrabold text-white text-xl text-1xl">{{ $otherOwned['vacant_office'] }}</span>
                                </div>
                            @endif
                        </div>
                    </a>
