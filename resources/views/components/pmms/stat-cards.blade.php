    ...
    <div class="group relative overflow-hidden rounded-2xl p-5 text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
        ...
        <div class="relative">
            ...
            <span class="mt-2 inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-semibold" style="background: rgba(255,255,255,0.2);">
                {{ $occupancyRate }}% Rented
            </span>
        </div>
    </div>

    {{-- Rented Units — Emerald Green --}}
    <div class="group relative overflow-hidden rounded-2xl p-5 text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
        ...
        <div class="relative">
            ...
            <p class="text-xs font-semibold uppercase tracking-widest" style="color: rgba(255,255,255,0.75);">Rented</p>
            <h4 class="mt-1 text-3xl font-extrabold">{{ number_format($rentedUnits) }}</h4>
            <span class="mt-2 inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-semibold" style="background: rgba(255,255,255,0.2);">
                Active Tenants
            </span>
        </div>
