...
@section('content')
    <x-common.page-breadcrumb pageTitle="Edit Inspection Task" />
        ...
        <div
            ...
            <form action="{{ route('inspection-heads.update', $head) }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-end gap-3 border-t border-gray-100 pt-4 dark:border-gray-800">
                    ...
                    <button type="submit"
                        class="rounded-lg bg-brand-500 px-5 py-2 text-sm font-bold text-white hover:bg-brand-600">Update</button>
                </div>
            </form>
        </div>
    </div>
