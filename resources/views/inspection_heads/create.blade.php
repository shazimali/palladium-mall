...
@section('content')
    <x-common.page-breadcrumb pageTitle="Add Inspection Head" />

    <div class="mx-auto max-w-xl">
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03]">
            <h3 class="mb-5 text-lg font-extrabold text-gray-800 dark:text-white/90">New Inspection Head</h3>
            ...
            <form action="{{ route('inspection-heads.store') }}" method="POST" class="space-y-5">
                ...
                <div class="flex items-center justify-end gap-3 border-t border-gray-100 pt-4 dark:border-gray-800">
                    ...
                    <button type="submit" class="rounded-lg bg-brand-500 px-5 py-2 text-sm font-bold text-white hover:bg-brand-600">Create</button>
                </div>
            </form>
        </div>
    </div>
