    ...
    <x-common.component-card title="Update Utility Billing & Notes — {{ $unit->unit_number }}"
        ...
        <form action="{{ route('units.update', $unit) }}" method="POST">
            ...
            <div class="flex items-center gap-3 pt-4 mt-6 border-t border-gray-150 dark:border-gray-800">
                ...
                <a href="{{ route('units.show', $unit) }}"
                    class="ml-auto inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-655 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
