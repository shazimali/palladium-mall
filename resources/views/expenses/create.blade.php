    ...
    <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data"
        ...
        x-data="{
            ...
            handleSubmit(event) {
                ...
                Swal.fire({
                    title: 'Confirm Expense Voucher',
                    text: 'Are you sure you want to save and generate this expense voucher for Rs. ' + amt.toLocaleString('en-US', {minimumFractionDigits: 2}) + '?',
                    icon: 'question',
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 items-stretch">
                ...
                <div class="md:col-span-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 shadow-xs">
                    ...
                    <textarea name="notes" rows="2" placeholder="Expense voucher remarks or notes..."
                        class="w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-xl p-3.5 text-base sm:text-lg font-black text-gray-900 dark:text-white placeholder-gray-400 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none transition-all">{{ old('notes') }}</textarea>
                </div>
            </div>
