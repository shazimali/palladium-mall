        ...
        @foreach($permissions as $group => $groupPermissions)
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="border-b border-gray-100 bg-gray-50/50 px-5 py-4 dark:border-gray-800 dark:bg-white/[0.02]">
                    <h4 class="font-semibold text-gray-800 dark:text-white/90 text-sm uppercase tracking-wider">{{ $group }}
                    </h4>
                </div>
                            ...
                            @foreach($groupPermissions as $permission)
                                <tr class="border-b border-gray-100 last:border-0 dark:border-gray-800">
                                    <td class="px-5 py-4 sm:px-6">
                                        <span
                                            class="block font-medium text-gray-800 text-theme-sm dark:text-white/90">{{ $permission->display_name }}</span>
                                    </td>
                                    <td class="px-5 py-4 sm:px-6">
                                        <code
                                            class="rounded bg-gray-100 px-2 py-1 text-xs text-gray-600 dark:bg-gray-800 dark:text-gray-400">{{ $permission->name }}</code>
                                    </td>
