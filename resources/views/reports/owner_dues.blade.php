...
@section('content')
    ...
    <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div class="rounded-xl border border-gray-250 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <p class="text-[10px] text-gray-400 mt-1">Cumulative tenant collections & general receipts</p>
        </div>
        <div class="rounded-xl border border-gray-250 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <p class="text-[10px] text-gray-400 mt-1">Cumulative operational expenses</p>
        </div>
        <div class="rounded-xl border border-gray-250 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <p class="text-[10px] text-gray-400 mt-1">Net profit pool for managing owners</p>
        </div>
    </div>
