...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .summary-td { width: 100%; padding-right: 0; }
...
<body>
    ...
    <div class="section-desc">List of collections (e.g. tenant security deposits, contractor payables, landlord installments, expenses) that are held or owed by the building.</div>
    ...
    <div class="footer">
        Palladium Mall Payables Report &bull; Page 1 of 1
    </div>
