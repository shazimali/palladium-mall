...
@section('content')
    <div class="mx-auto max-w-3xl px-4 py-6">
        <div class="mb-6 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>/</span>
            <span class="text-gray-800 dark:text-white/90">Edit Inspector</span>
        </div>

        <x-common.component-card title="Edit Inspector — {{ $inspectionPerson->name }}" desc="Modify details of an existing inspection team member">
            <form action="{{ route('inspection-persons.update', $inspectionPerson) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $inspectionPerson->name) }}" placeholder="Full Name" 
                    ...
                    <div>
                        ...
                        <input type="text" name="designation" value="{{ old('designation', $inspectionPerson->designation) }}" placeholder="e.g. Inspector, Manager" 
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" value="{{ old('phone', $inspectionPerson->phone) }}" placeholder="Phone Number" 
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email', $inspectionPerson->email) }}" placeholder="Email Address" 
                    ...
                    <div class="sm:col-span-2">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $inspectionPerson->is_active) ? 'checked' : '' }}
