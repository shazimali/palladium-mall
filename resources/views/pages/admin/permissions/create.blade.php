            ...
            <form action="{{ route('admin.permissions.store') }}" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="display_name" id="display_name" value="{{ old('display_name') }}" placeholder="e.g., View Users"
                    ...
                    <div>
                        ...
                        <input type="text" name="group" id="group" value="{{ old('group') }}" placeholder="e.g., User Management" list="group-list"
