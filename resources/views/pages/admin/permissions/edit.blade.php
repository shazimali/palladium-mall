            ...
            <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="display_name" id="display_name" value="{{ old('display_name', $permission->display_name) }}" placeholder="e.g., View Users"
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $permission->name) }}" placeholder="e.g., users.view"
                    ...
                    <div>
                        ...
                        <input type="text" name="group" id="group" value="{{ old('group', $permission->group) }}" placeholder="e.g., User Management" list="group-list"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 @error('group') border-red-500 @enderror" required />
                ...
                <div class="mt-6 flex items-center justify-end gap-3">
                    <a href="{{ route('admin.permissions.index') }}" class="rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/5">
                        Cancel
                    </a>
