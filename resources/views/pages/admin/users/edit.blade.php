            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST">
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div>
                        ...
                        <span class="mt-1 block text-xs text-gray-400">Only fill this out if you wish to change their password.</span>
                        @error('password')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-400 {{ $user->id === auth()->id() ? 'opacity-50' : '' }}">Account is Active</span>
                        </label>
                        @if($user->id === auth()->id())
                ...
                <div class="mt-6 flex items-center justify-end gap-3">
                    <a href="{{ route('admin.users.index') }}" class="rounded-lg border border-gray-300 px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-white/5">
                        Cancel
                    </a>
