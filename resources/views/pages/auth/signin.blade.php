            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        <div>
                            <form id="signin-form" method="POST" action="{{ route('login.store') }}">
                                @csrf
                                <div class="space-y-5">
                                    <!-- Email -->
                                    <div>
                                        ...
                                        <input
                                            ...
                                            autocomplete="email"
                                            required
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 {{ $errors->has('email') ? 'border-red-500 dark:border-red-500' : 'border-gray-300 dark:border-gray-700' }}" />
                                        @error('email')
