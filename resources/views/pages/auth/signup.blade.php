                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <input type="text" id="first_name" name="first_name"
                                            ...
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 {{ $errors->has('first_name') ? 'border-red-500' : 'border-gray-300 dark:border-gray-700' }}" />
                                        @error('first_name')
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <input type="text" id="last_name" name="last_name"
                                            ...
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 {{ $errors->has('last_name') ? 'border-red-500' : 'border-gray-300 dark:border-gray-700' }}" />
                                        @error('last_name')
                                            <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email"
                                        ...
                                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 {{ $errors->has('email') ? 'border-red-500' : 'border-gray-300 dark:border-gray-700' }}" />
                                    @error('email')
                                        <p class="mt-1.5 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                                </div>
