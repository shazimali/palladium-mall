...
@section('content')
    <x-common.page-breadcrumb pageTitle="Edit Agreement — {{ $agreement->tenant->name }}" />

    <x-common.component-card title="Edit Agreement — {{ $agreement->tenant->name }}"
        desc="Update agreement terms, dates or upload a new document">
