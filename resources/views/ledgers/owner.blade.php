...
@section('fullViewTitle', 'Managing Owner Ledger')
        ...
        @if($ledgerData)
            ...
            <div data-ledger-table class="overflow-auto max-h-[70vh] border-2 border-gray-200 rounded-2xl dark:border-gray-800 shadow-md">
                <table class="w-full text-xs sm:text-[13.5px] text-left text-gray-900 dark:text-gray-100">
                    <thead
                        class="sticky top-0 z-10 text-xs font-black uppercase tracking-wider bg-brand-600 text-white dark:bg-brand-700 border-b-2 border-gray-200 dark:border-gray-700">
                        <tr>
