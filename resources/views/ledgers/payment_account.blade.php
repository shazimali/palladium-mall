        ...
        @if($ledgerData)
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
                <div class="bg-green-50/50 dark:bg-green-950/10 p-5 rounded-xl border border-green-100 dark:border-green-900/30">
                    <span class="text-xs font-semibold uppercase tracking-wider text-green-500 dark:text-green-400">Total Inflows (Debits)</span>
                    <span class="block mt-2 text-2xl font-bold text-green-600 dark:text-green-400">Rs. {{ number_format($ledgerData['summary']['total_inflow'], 2) }}</span>
                </div>
                <div class="bg-blue-50/50 dark:bg-blue-950/10 p-5 rounded-xl border border-blue-100 dark:border-blue-900/30">
                    <span class="text-xs font-semibold uppercase tracking-wider text-blue-500 dark:text-blue-400">Total Outflows (Credits)</span>
                    <span class="block mt-2 text-2xl font-bold text-gray-800 dark:text-white">Rs. {{ number_format($ledgerData['summary']['total_outflow'], 2) }}</span>
                </div>
                <div class="bg-gray-50 dark:bg-gray-800/40 p-5 rounded-xl border border-gray-150 dark:border-gray-800">
                    <span class="text-xs font-semibold uppercase tracking-wider text-gray-500">Account Running Balance</span>
                ...
                <table class="w-full text-sm text-left text-gray-600 dark:text-gray-400">
                    <thead class="text-xs uppercase bg-gray-50 text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                        <tr>
                            ...
                            <th class="px-5 py-3.5 text-right">Debit (Inflow)</th>
                            <th class="px-5 py-3.5 text-right">Credit (Outflow)</th>
