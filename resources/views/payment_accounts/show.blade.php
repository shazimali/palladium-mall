            ...
            <x-common.component-card title="Account Information" desc="Configured details and status">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white">{{ $paymentAccount->bank_name ?? '—' }}
                        </p>
                    </div>

                    {{-- Account Number --}}
                    <div>
                        <span class="text-xs font-semibold uppercase tracking-wider text-gray-400">Account / Wallet
                            Number</span>
                        <p class="font-mono text-sm text-gray-800 dark:text-white">
                            {{ $paymentAccount->account_number ?? '—' }}</p>
                    </div>

                    {{-- Holder Name --}}
                    <div>
                        <span class="text-xs font-semibold uppercase tracking-wider text-gray-400">Account Holder
                            Name</span>
                    ...
                    <div>
                        ...
                        <div>
                            @if($paymentAccount->is_active)
                                <span
                                    class="inline-flex items-center rounded-md bg-green-50 px-2 py-0.5 text-xs font-medium text-green-700 dark:bg-green-900/20 dark:text-green-400">
