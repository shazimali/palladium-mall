...
@section('content')
    <div class="mx-auto max-w-2xl px-4 py-6">
        <div class="mb-6 flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>/</span>
            <span class="text-gray-800 dark:text-white/90">Create Expense Head</span>
        </div>

        <x-common.component-card title="Create Expense Head" desc="Add a new category for tracking organizational expenditures">
            <form action="{{ route('expense-heads.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Office Stationery, Janitorial Supplies" 
