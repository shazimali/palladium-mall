                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="display_name" id="display_name" value="{{ old('display_name') }}" placeholder="e.g., Manager"
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="e.g., manager"
