...
@section('content')
    <x-common.page-breadcrumb pageTitle="New Paid Voucher" />
    ...
    <form action="{{ route('payment-vouchers.store') }}" method="POST"
        ...
        x-data="{
            ...
            handleSubmit(event) {
                ...
                Swal.fire({
                    title: 'Confirm Create Payment Voucher',
                    text: 'Are you sure you want to save and generate this payment voucher for Rs. ' + amt.toLocaleString('en-US', {minimumFractionDigits: 2}) + '?',
                    icon: 'question',
